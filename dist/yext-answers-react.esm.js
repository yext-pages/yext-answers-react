...
function createFacets(facets) {
  ...
  return facets.map(function (facet) {
    ...
    var displayName = facet.displayName ? facet.displayName : 'emptyDisplayName';
...
var useAnswers = function useAnswers() {
  ...
  var simpleFilter = /*#__PURE__*/function () {
    var _ref7 = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee7(fieldId, value) {
      var facets;
    ...
    return function simpleFilter(_x12, _x13) {
