...
var sortFacets = function sortFacets(facets) {
  return facets.map(function (f) {
    return _extends({}, f, {
      options: f.options.sort(function (a, b) {
        if (a.selected && b.selected) return b.count - a.count;else if (a.selected) return -1;else if (b.selected) return 1;else return b.count - a.count;
      })
    });
  });
};
    ...
    case 'SET_VERTICAL_RESPONSE':
      {
        ...
        var facetFilters = [].concat(state.facetFilters.filter(function (f) {
          var matchedIndex = newFacetFilters.findIndex(function (g) {
            return g.fieldId === f.fieldId && g.comparedValue === f.comparedValue;
          });
        ...
        return _extends({}, state, {
          ...
          facets: facetSorter ? facetSorter(_facets) : sortFacets(_facets),
...
var useAnswers = function useAnswers() {
  ...
  var handleSearch = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee2(searchTerm, facetFilters, sortBys) {
      var res;
  ...
  var handleSearchTermChange = /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee3(searchTerm) {
      var res;
    ...
    return function handleSearchTermChange(_x6) {
      return _ref3.apply(this, arguments);
    };
  }();

  var updateSortBys = /*#__PURE__*/function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee4(sortBys, updateSearchResults) {
    ...
    return function updateSortBys(_x7, _x8) {
  ...
  var toggleFacet = /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              removed = false;
              updatedFacetFilters = facetFilters.filter(function (f) {
    ...
    return function toggleFacet(_x9, _x10, _x11) {
  ...
  var simpleFilter = /*#__PURE__*/function () {
    var _ref7 = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee7(fieldId, comparator, comparedValue) {
      var simpleFilters;
      return runtime_1.wrap(function _callee7$(_context7) {
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
              if (comparedValue === void 0) {
                comparedValue = 'test';
              }
    ...
    return function simpleFilter(_x12, _x13, _x14) {
...
var AnswersContext = function AnswersContext(props) {
  return React.createElement(QueryParamProvider, null, React.createElement(AnswersStore, null, React.createElement(Inner, Object.assign({}, props))));
};
